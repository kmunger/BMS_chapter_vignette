...
annotate("text", label = "SOTU", x = 1903, y = 1.66, size = 6, colour = "black")+
  annotate("text", label = "UK Manifestos", x = 1985, y = 1.72, size = 6, colour = "black") +
   annotate("text", label = "Party Broadcasts", x = 1952, y = 1.45, size = 6, colour = "black") + 
...
pdf(file="C:/Users/kevin/Documents/GitHub/sophistication/manuscript_chapter/plots//Comparative_series_greyscale_syllables.pdf", height=7, width=12)
print(p)
